...
data['FAMINCOME2'] = 0
data.loc[i1, 'FAMINCOME2'] = 1 # < $30,000
data.loc[i2, 'FAMINCOME2'] = 2 # > $30,000 and < $50,000
data.loc[i3, 'FAMINCOME2'] = 3 # > $50,000 and < $100,000
data.loc[i4, 'FAMINCOME2'] = 4 # > $100,000
...
data['EMPSTAT2'] = 0
data.loc[i1, 'EMPSTAT2'] = 1 # Employed
data.loc[i2, 'EMPSTAT2'] = 2 # Unemployed
data.loc[i3, 'EMPSTAT2'] = 3 # Not in labor force

score_attr = 'ACT_PCARE'
